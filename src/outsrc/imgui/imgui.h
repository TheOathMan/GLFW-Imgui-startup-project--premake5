...
typedef int Window_Resize_Dir_Flags;//[Edited]
...
//[Edited]: I have added a normalized function 
...
namespace ImGui
{
    ...
    //[Edited]: new Begin with our resize flags
    //bool ImGui::Begin(const char* name, bool* p_open, ImGuiWindowFlags flags, Window_Resize_Dir wrd = WRD_FULL)
    IMGUI_API bool          Begin(const char* name, bool* p_open = NULL, ImGuiWindowFlags flags = 0, Window_Resize_Dir_Flags WRDF = 0);
    IMGUI_API void          End();
...
struct ImGuiTextFilter
{
    ...
    {
        const char*     b;
        const char*     glyph_setting;

        ImGuiTextRange()                                { b = glyph_setting = NULL; }
        ImGuiTextRange(const char* _b, const char* _e)  { b = _b; glyph_setting = _e; }
        bool            empty() const                   { return b == glyph_setting; }
